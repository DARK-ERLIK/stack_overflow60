...
class RegisterForm(FlaskForm):
    name = StringField(
        ...
        validators=[
            DataRequired("Поле 'Имя' обязательно для заполнения"),
    ...
    email = EmailField(
        ...
        validators=[
            DataRequired("Поле 'Email' обязательно для заполнения")
        ],
    ...
    password1 = PasswordField(
        label="Пароль",
        validators=[
            DataRequired("Придумайте пароль"),
...
class LoginForm(FlaskForm):
    name = StringField(
        label="Имя пользователя",
        validators=[DataRequired("Введите ваше имя")],
...
class QuestionForm(FlaskForm):
    title = StringField(
        ...
        validators=[
            DataRequired("Заголовок не может быть пустым"),
    ...
    text = TextAreaField(
        ...
        validators=[
            DataRequired("Опишите ваш вопрос подробнее"),
...
class AnswerForm(FlaskForm):
    text = TextAreaField(
        label="Ваш ответ",
        validators=[
            DataRequired("Ответ не может быть пустым"),
